...
|---------------|------------------|-----------------------|-------------------|----------------------------------|----------------------------------|
| **Small-1500**   | 2 000            | 100                   | 1500               | 0,07305                            | 2,83005                         |
...
Анализ данных из сводной таблицы тестовых данных демонстрирует, что на время генерации документов существенно влияет как количество тегов, так и объем текста в файле, при этом эффект от количества тегов является более выраженным.
...
- **Конвертация в PDF:**  
  Время, указанное для конвертации в PDF, включает в себя время генерации документа. Зависимость наблюдается только от количества слов в файле, это видно по разнице между общим временем конвертации и временем генерации:
