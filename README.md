...
8. [Возникшие проблемы](#Problems)
9. [Лицензия](#License)
10. [Авторы](#ProjectAuthors)
...
## <a name="Testing"></a> 7. Тестирование
...
## <a name="Problems"></a> 8. Возникшие проблемы
...
## <a name="License"></a> 9. Лицензия

Этот проект распространяется под лицензией GNU General Public License v3.0.

## <a name="ProjectAuthors"></a> 10. Авторы
