...
3. [Первичные настройки библиотеки](#Settings)
4. [Работа с документами типа .doc](#Doc)
5. [Работа с документами типа .docx](#Docx)
6. [Работа с несколькими авторами](#Authors)
7. [Конвертация в PDF](#ConvertPDF)
8. [Оконное приложение](#Window)
9. [Тестирование](#Testing)
10. [Возникшие проблемы](#Problems)
11. [Лицензия](#License)
12. [Авторы](#ProjectAuthors)
...
## <a name="Architecture"></a> 2. Архитектура системы

Ниже представлена UML-диаграмма основных классов нашего приложения:

![Диаграмма классов](diagrams/class-diagram.png)


## <a name="Settings"></a> 3. Первичные настройки библиотеки
...
## <a name="Doc"></a> 4. Работа с документами типа .doc
...
## <a name="Docx"></a> 5. Работа с документами типа .docx
...
## <a name="Authors"></a> 6. Работа с несколькими авторами
...
## <a name="ConvertPDF"></a> 7. Конвертация в PDF
...
## <a name="Window"></a> 8. Оконное приложение
...
## <a name="Testing"></a> 9. Тестирование
...
## <a name="Problems"></a> 10. Возникшие проблемы
...
## <a name="License"></a> 11. Лицензия

Этот проект распространяется под лицензией GNU General Public License v3.0.

## <a name="ProjectAuthors"></a> 12. Авторы
